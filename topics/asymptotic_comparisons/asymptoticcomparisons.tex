...
\NewDocumentCommand\pdftitle{}{On asymptotic comparisons}
...
\declaretheoremstyle[postheadspace=\newline,headpunct={},spaceabove=1em,spacebelow=1em,shaded={rulecolor=black, rulewidth=.2pt, bgcolor=white}]{mainth}
	...
	\declaretheorem[sibling=prop,style=thstyle,name=Example]{ex}
    \declaretheorem[sibling=prop,style=thstyle,name=Counterexample]{cex}
...
\begin{cex}[Equivalence to supremum]
